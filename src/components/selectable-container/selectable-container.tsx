import { FC, FocusEventHandler, HTMLProps, useCallback } from "react";

export interface SelectableContainerProps extends HTMLProps<HTMLDivElement> {
 ...
 */
export const SelectableContainer: FC<SelectableContainerProps> = ({ tabIndex = -1, onSelect, onFocus, ...props }) => {
